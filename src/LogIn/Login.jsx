...
export function Login({ weather }) {
  return (
    <main className="container">
      ...
      <h2 className="mb-5">Current Deals / Promotions $$$</h2> 
      ...
      <div className = "card" style={{width: '15rem'}}>
        ...
        <div className = "card-body">
          ...
          <p className="card-text">Comprehensive pest control solutions for your home.</p>
          <NavLink to="/Services" className="btn btn-primary">Learn More</NavLink>
        </div>
      </div>
      <div className = "card" style={{width: '15rem'}}>
        ...
        <div className = "card-body">
          ...
          <p className="card-text">Effective pest management for your business premises.</p>
          <NavLink to="/Services" className="btn btn-primary">Learn More</NavLink>
        </div>
      </div>  
      <div className = "card" style={{width: '15rem'}}>
        ...
        <div className = "card-body">
          ...
          <p className="card-text">Protect your property from costly termite damage.</p>
          <NavLink to="/Services" className="btn btn-primary">Learn More</NavLink>
        </div>
      </div>
      <div className = "card" style={{width: '15rem'}}>
        ...
        <div className = "card-body">
          ...
          <p className="card-text">Safe and effective solutions to keep rodents at bay.</p>
          <NavLink to="/Services" className="btn btn-primary">Learn More</NavLink>
        </div>
      </div>
      <div className = "card" style={{width: '15rem'}}>
        ...
        <div className = "card-body">
          ...
          <p className="card-text">Get rid of ants quickly and discreetly.</p>
          <NavLink to="/Services" className="btn btn-primary">Learn More</NavLink>
        </div>
      </div>
        <div className="card" style={{width: '15rem'}}>
      ...
      <div className="d-flex mt-5 mb-5 justify-content-center">
        <div className="card w-auto text-center">
          <div className="card-body">
          <h3>Why Choose Phoenix Pest Control?</h3>
          <ul className="list-unstyled">
            <li>Experienced and Licensed Professionals</li>
            <li>Eco-Friendly and Safe Products</li>
            <li>Customized Pest Management Plans</li>
