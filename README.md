...
- [x] **Bundled using Vite** - I used Vite to run my website with 'npm run dev'
- [x] **Components** - I had multiple React Components(Login, Services, AboutUs, ContactUs, SignIn, and CustomerPortal)
- [x] **Router** - I used this to navigate through my website by using <BrowserRouter>, <Routes>, and <NavLink>.

## 🚀 React part 2: Reactivity deliverable

For this deliverable I did the following. I checked the box `[x]` and added a description for things I completed.

- [x] **All functionality implemented or mocked out** -I used a mock Sign In page with useState and localStorage. I hard-coded the information. I also made a mock weather service with useState and setInterval to mock live updates.
- [x] **Hooks** -Used useState for user and weather functionality, and useEffect to load the saved information from localStorage.
...
- [x] **Stores data in MongoDB** -database.js connected MongoDB to PhoenixPests database and stored appointments and contact information.
- [x] **Stores credentials in MongoDB** - Passwords are hashed with bcryptjs, and auth tokens are saved to the database.
